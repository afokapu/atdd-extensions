...
# BINDING BREAK (declaration_to_station): the interlocking declares entrypoint.exposed:true with
# entrypoint.actions: [resolve_match], but resolve_match is NOT wired into JOURNEY_MAP at all — the
# exposed interlocking is unreachable from the Station Master. Only a direct route remains.
JOURNEY_MAP = {
