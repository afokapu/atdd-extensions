#!/usr/bin/env node
// Member check: coder.vite.green-header-runtime  (GREEN/URN traceability family)
//
...
runCheck("coder.vite.green-header-runtime", (H, file) => {
  const ALLOWED = new Set(["vite", "browser", "node"]);
