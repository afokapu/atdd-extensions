#!/usr/bin/env node
// FAMILY validator: convex_interlocking_infrastructure
// Convex/TS realization of the core python `interlocking_infrastructure.py` detector — five strict
// coder.convex.interlocking-* rule_ids from ONE implementation (Core FAMILY pattern). Runs each member
...
process.stderr.write("family convex_interlocking_infrastructure: " + out.length + " violation(s)\n");
process.exit(0);
