#!/usr/bin/env node
// FAMILY validator: convex_smoke_fidelity_detector
// Runs each member check (checks/*.mjs) VERBATIM as a subprocess and merges their
// RAW v1.1 reports into one. ONE implementation realizing a family of tester SMOKE
// fidelity rule_ids (Core FAMILY pattern). Member logic is preserved byte-for-byte.
...
process.stderr.write("family convex_smoke_fidelity_detector: " + out.length + " violation(s)\n");
process.exit(0);
