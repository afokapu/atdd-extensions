...
//
// No routeCategoryDigit: core retired the digit (#1421 / #1440). The /\brouteCategory\b/ boundary
// still earns its keep — a trailing "Digit" defeats it, so a LEGACY consumer emitting only
// routeCategoryDigit is still reported as missing routeCategory rather than silently passing.
